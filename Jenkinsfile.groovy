...
podTemplate(label: 'mypod', containers: [
    ...
    node('mypod') {
        ...
        stage('checkout & unit tests & build') {
            git url: 'https://github.com/AdrianJetzer/football'
            container('maven') {
        ...
        stage('build image & git tag & docker push') {
            ...
            withCredentials([usernamePassword(credentialsId: 'github78', passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
                sh "git push https://${GIT_USERNAME}:${GIT_PASSWORD}@github.com/AdrianJetzer/football.git --tags"
            }
